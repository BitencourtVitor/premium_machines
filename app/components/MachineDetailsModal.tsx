...
import MachineHistoryCalendar from './MachineHistoryCalendar'
...
export default function MachineDetailsModal({
  ...
  return (
    ...
    >
      ...
      <div 
        ref={modalRef}
        className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] flex flex-col overflow-hidden border border-gray-200 dark:border-gray-800 transform transition-all"
      >
        {/* Header */}
        ...
        <div className="flex-1 overflow-hidden flex flex-col bg-gray-50/50 dark:bg-black/20">
          {loading ? (
            ...
            <div className="flex-1 overflow-hidden flex flex-col p-6 sm:p-8 gap-6">
              ...
              {/* Event Timeline */}
              <div className="flex-1 min-w-0 lg:max-w-[55%] overflow-hidden flex flex-col bg-white dark:bg-gray-800/50 rounded-2xl border border-gray-200 dark:border-gray-700/50 shadow-sm p-6">
              ...
              {/* Historical Calendar */}
              <div className="w-full lg:flex-1 overflow-hidden flex flex-col bg-white dark:bg-gray-800/50 rounded-2xl border border-gray-200 dark:border-gray-700/50 shadow-sm p-5">
                <h3 className="text-base font-bold text-gray-900 dark:text-white mb-4 flex-shrink-0 flex items-center gap-2">
